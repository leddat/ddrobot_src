    ...
    heading_(0)
{
    ...
    velocity_subscriber_ = nh_.subscribe("raw_vel", 50, &TwistToOdom::velCallback, this);
}

void TwistToOdom::velCallback(const geometry_msgs::Twist& vel)
{
